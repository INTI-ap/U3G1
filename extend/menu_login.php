...
<ul id="menu" class="side-nav fixed grey lighten-4">
  <li>
    <div class="userView">
      ...
      <a href="#"><img src="/U3G1/vista/img/avatar_default.png" class="circle" alt="Usuario"></a>
  ...
  <li><a href="/U3G1/controlador/usuarios/" class="waves-effect"><i class="material-icons">people</i>Usuarios</a></li>
  <li><a href="/U3G1/controlador/clientes/" class="waves-effect"><i class="material-icons">assignment_ind</i>Clientes</a></li>
  <li><a href="/U3G1/controlador/productos/" class="waves-effect"><i class="material-icons">shopping_cart</i>Productos</a></li>
  <li><a href="/U3G1/controlador/venta/" class="waves-effect"><i class="material-icons">attach_money</i>Ventas</a></li>
  <li><div class="divider"></div></li>

  <!-- SALIR -->
  <li><a href="/U3G1/" class="waves-effect"><i class="material-icons">exit_to_app</i>Salir</a></li>
  <li><div class="divider"></div></li>
</ul>
...
<div class="fixed-action-btn vertical click-to-toggle">
  ...
  <ul>
    <li><a href="/U3G1/controlador/usuarios/" class="btn-floating blue"><i class="material-icons">person_add</i></a></li>
    <li><a href="/U3G1/controlador/productos/" class="btn-floating green"><i class="material-icons">add_shopping_cart</i></a></li>
    <li><a href="/U3G1/controlador/clientes/" class="btn-floating orange"><i class="material-icons">group_add</i></a></li>
  </ul>
</div>